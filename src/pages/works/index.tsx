...
type ColumnType = ColumnDef<WorkInterface, unknown>;
...
export function WorkListPage(props: WorkListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<WorkInterface>>(
    () => `/works?params=${JSON.stringify(params)}`,
    fetcher,
  );
